...
class LinkListTest {
  ...
  @Test
  void testFindNthNode() {
    LinkListNode<Integer> root = LinkListNode.from(1, 2, 3, 4, 5, 6);
    assertEquals(5, root.fineNthLastNode(2).getValue().intValue());
    assertEquals(2, root.fineNthLastNode(5).getValue().intValue());
  }

  @Test
  void testIntersecNode() {
    LinkListNode<Integer> root = LinkListNode.from(1, 2, 3, 4, 5, 6);
  ...
  void testRemoveNode() {
    ...
    assertEquals(2, root.fineNthLastNode(4).getValue().intValue());
    root.removeNode(root.fineNthLastNode(1));
    assertEquals(5, root.fineNthLastNode(1).getValue().intValue());
  }
}
