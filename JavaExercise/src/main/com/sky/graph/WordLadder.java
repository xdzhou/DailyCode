...
public class WordLadder implements Problem<Triple<String, String, Set<String>>, List<List<String>>>
{
    ...
    private void DFS(Map<String, Set<String>> pathGraph, String from, String to, List<String> path, List<List<String>> result)
    {
        if(from.equals(to))
        {
    ...
    private boolean biDirectionBFS(Set<String> beginGroup, Set<String> endGroup, Map<String, Set<String>> pathGraph, Set<String> datas)
    {
