...
class MergeKSortedListsTest {
  ...
  @Test
  void singleListNode() {
    ListNode node = ListNode.createNodes(1, 2, 3);
    Assertions.assertTrue(node.equalTo(MergeKSortedLists.merge(node)));
  }

  @Test
  void merge() {
    ListNode l1 = ListNode.createNodes(1, 4, 5);
    ListNode l2 = ListNode.createNodes(1, 3, 4);
    ListNode l3 = ListNode.createNodes(2, 6);
    ListNode expected = ListNode.createNodes(1, 1, 2, 3, 4, 4, 5, 6);
